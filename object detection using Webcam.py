...
net = cv2.dnn.readNetFromCaffe('C:/Users/hp/YOLO-object-detection-with-OpenCV-master/object detection using webcam/MobileNetSSD_deploy.prototxt.txt', 'C:/Users/hp/YOLO-object-detection-with-OpenCV-master/object detection using webcam/MobileNetSSD_deploy.caffemodel')
...
#Reading each frame
	...
	(h, w) = frame.shape[:2]
	#Blobing a 4 dimensional array from the frameAC
